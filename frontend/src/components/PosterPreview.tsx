...
export default function PosterPreview({ reflection, template }: PosterPreviewProps) {
      ...
      >
        ...
        <div className="relative h-full flex flex-col justify-between p-8 text-white">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold leading-tight drop-shadow-lg">{reflection.title}</h2>
            <p className="text-sm leading-relaxed drop-shadow-md opacity-95">{excerpt}</p>
          </div>
