...
import { BookOpen, Sparkles, FolderOpen, Shield, HelpCircle, Copy, Check } from 'lucide-react';
      ...
      <Card className="w-full max-w-2xl shadow-lg">
        <CardHeader className="text-center space-y-4">
          <div className="flex justify-center">
            <img src="/assets/generated/logo-mark.dim_512x512.png" alt="ReflectPoster" className="h-20 w-20" />
          </div>
          <CardTitle className="text-3xl font-bold">Welcome to ReflectPoster</CardTitle>
          <CardDescription className="text-base">
            Create beautiful academic posters from your reflections and share them on LinkedIn
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="grid gap-4 md:grid-cols-3">
            <div className="flex flex-col items-center text-center p-4 rounded-lg bg-muted/50">
              ...
              <p className="text-xs text-muted-foreground">Capture your learning journey</p>
            </div>
            <div className="flex flex-col items-center text-center p-4 rounded-lg bg-muted/50">
              <Sparkles className="h-8 w-8 mb-2 text-primary" />
              <h3 className="font-semibold mb-1">Generate Posters</h3>
              <p className="text-xs text-muted-foreground">Choose from academic templates</p>
            </div>
            <div className="flex flex-col items-center text-center p-4 rounded-lg bg-muted/50">
          ...
          <div className="border-t border-border pt-4 space-y-3">
            <div className="bg-muted/30 p-3 rounded-lg">
              <div className="flex items-center justify-between gap-2 mb-2">
                <span className="text-sm font-medium text-foreground">Share this app:</span>
                <Button
                  variant="outline"
                  size="sm"
