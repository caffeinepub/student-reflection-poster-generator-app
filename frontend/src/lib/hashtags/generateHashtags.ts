const STOPWORDS = new Set([
  ...
  'our', 'their', 'me', 'him', 'them', 'what', 'which', 'who', 'when', 'where',
...
export function generateHashtags(text: string, maxHashtags: number = 5): string[] {
  ...
  const commonTags = ['Learning', 'Reflection', 'Growth', 'Education', 'StudentLife'];
