...
export default function ImproveReflectionPanel({
  reflectionText,
  onApply,
}: ImproveReflectionPanelProps) {
    ...
    <>
      <Card className="border-primary/50">
        <CardHeader>
          ...
          <CardDescription>
            AI-powered suggestions to enhance your reflection
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="clarity">
            ...
            <TabsContent value="clarity" className="space-y-3">
              ...
              <div className="p-3 bg-muted rounded-lg">
                ...
                <p className="text-sm text-muted-foreground">
                  {suggestions.clarity.rewrite}
                </p>
              </div>
              <Button
                onClick={() => handleApplyClick(suggestions.clarity.rewrite)}
                variant="outline"
                size="sm"
              >
                Apply This Version
            ...
            <TabsContent value="structure" className="space-y-3">
              ...
              <div className="p-3 bg-muted rounded-lg">
                <p className="text-sm mb-2 font-medium">Suggested rewrite:</p>
                <p className="text-sm text-muted-foreground">
                  {suggestions.structure.rewrite}
                </p>
              </div>
              <Button
                onClick={() => handleApplyClick(suggestions.structure.rewrite)}
                variant="outline"
                size="sm"
              >
                Apply This Version
            ...
            <TabsContent value="tone" className="space-y-3">
              ...
              <div className="p-3 bg-muted rounded-lg">
                <p className="text-sm mb-2 font-medium">Suggested rewrite:</p>
                <p className="text-sm text-muted-foreground">
                  {suggestions.tone.rewrite}
                </p>
              </div>
              <Button
                onClick={() => handleApplyClick(suggestions.tone.rewrite)}
                variant="outline"
                size="sm"
              >
                Apply This Version
      ...
      <AlertDialog open={showConfirm} onOpenChange={setShowConfirm}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will replace your current reflection body with the suggested
              version. You can always edit it further after applying.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
