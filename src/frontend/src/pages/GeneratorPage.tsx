...
export default function GeneratorPage() {
  ...
  const handleGenerate = () => {
    ...
    const generatedHashtags = generateHashtags(
      `${selectedReflection.title} ${selectedReflection.body}`,
    );
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Choose a reflection to turn into a poster
            </CardDescription>
          </CardHeader>
              ...
              >
                ...
                <SelectContent>
                  {reflections.map((reflection) => (
                    <SelectItem key={reflection.title} value={reflection.title}>
                      {reflection.title}
                    </SelectItem>
                  ))}
                </SelectContent>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button
              ...
              disabled={!selectedReflection || !selectedTemplate}
            >
