...
export class Backend implements backendInterface {
    ...
    async generatePoster(arg0: Reflection, arg1: bigint, arg2: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.generatePoster(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFilteredReflections(arg0: string): Promise<Array<Reflection>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilteredReflections(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLastReflections(arg0: bigint): Promise<Array<Reflection>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLastReflections(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPortfolioByHashtag(arg0: string): Promise<Array<PortfolioItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPortfolioByHashtag(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReflection(): Promise<Array<Reflection>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReflection();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateReflection(arg0: Reflection): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateReflection(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
